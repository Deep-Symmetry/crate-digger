...
[link=https://maven-badges.herokuapp.com/maven-central/org.deepsymmetry/crate-digger]
image:https://maven-badges.herokuapp.com/maven-central/org.deepsymmetry/crate-digger/badge.svg[Maven Central]
