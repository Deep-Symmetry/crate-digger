...
The file link:src/main/kaitai/pdb.ksy[`pdb.ksy`] contains
...
link:src/main/kaitai/pdb.ksy[`pdb.ksy`] file, and the Web
...
download my link:src/main/kaitai/pdb.ksy[`pdb.ksy`], click
...
link:src/main/kaitai/anlz.ksy[`anlz.ksy`]. You can use it
...
PdbFile.TrackRow track = database.findTrack(1);
