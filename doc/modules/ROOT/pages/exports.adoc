...
|00 |tracks |Track metadata: title, artist, genre, artwork ID, playing time, etc., TODO: 1.3.10
|01 |genres |Musical genres, for reference by tracks and searching, TODO: 1.3.5.
...
|04 |labels |Music labels, for reference by tracks and searching, TODO: 1.3.7
|05 |keys |Musical keys, for reference by tracks, searching, and key matching, TODO: 1.3.6
|06 |colors |Color labels, for reference by tracks and searching, TODO: 1.3.4
|07 |playlist_tree |Describes the hierarchical tree structure of available playlists and folders grouping them, TODO: 1.3.8
|08 |playlist_entries |Links tracks to playlists, in the right order, TODO: 1.3.9
