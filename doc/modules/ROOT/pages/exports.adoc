...
|02 |artists |Artists, for reference by tracks and searching, TODO: 1.3.2.
|03 |albums |Albums, for reference by tracks and searching, TODO: 1.3.1.
...
|0d |artwork |File paths of album artwork images, TODO: 1.3.3
