...
<<djl-analysis:ROOT:track_metadata#alternate-track-sort-orders,packet
...
|14|__analyze_path__|File path of the <<analysis-files,track analysis>>.
...
<<track-rows,track row>>. These files have names like `ANLZ0001.DAT`
